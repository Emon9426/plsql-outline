-- =============================================================================
-- 用例: Procedure / 长代码(简单结构) (procedure/proc_long.prc)
-- 本文件由 ZCodeTest/generate-long.js 确定性生成(10,000+ 行), 请勿手工编辑;
-- 再生: node ZCodeTest/generate-long.js
-- 覆盖: 多行签名(含 OUT 参数)
-- 覆盖: 声明区全家桶(变量池120/常量/游标/类型/异常)
-- 覆盖: 直线体: 赋值/IF/FOR/WHILE/基础LOOP/内联DECLARE块
-- 覆盖: EXCEPTION 多 WHEN
-- =============================================================================
CREATE OR REPLACE PROCEDURE pr_long_batch_migrate(
    p_src        IN  VARCHAR2,

-- =============================================================================
-- 用例: Trigger / 长代码+复杂结构 (trigger/trg_long_complex.trg)
...
-- 覆盖: EXCEPTION 多 WHEN
-- =============================================================================
CREATE OR REPLACE TRIGGER trg_long_complex_guard
...
DECLARE
    ...
    PROCEDURE sub_calc_trg(
        ...
        FUNCTION sub_format_trg(p_v IN NUMBER) RETURN VARCHAR2 IS
            v_txt  VARCHAR2(100);

            -- ----- 嵌套子程序 第 3 层: 子过程(位于子函数内) -----
            PROCEDURE sub_check_trg(p_v2 IN NUMBER) IS
            BEGIN
                IF p_v2 < 0 THEN
                    RAISE e_invalid;
                END IF;
    ...
    BEGIN
        ...
        v_pool_0001 := v_pool_0001 + LENGTH(sub_format_trg(v_step));
        p_out := v_step;
    EXCEPTION
        WHEN e_invalid THEN
            p_out := -1;
...
BEGIN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0003 := v_pool_0003 + v_local_0063;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0012 := LENGTH(q'[value -- inline /* mark */ 0072]');
    v_pool_0013 := v_pool_0013 + LENGTH(q'{paired (text) 0072}');
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0048 := v_pool_0048 + v_local_0108;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0057 := LENGTH(q'[value -- inline /* mark */ 0117]');
    v_pool_0058 := v_pool_0058 + LENGTH(q'{paired (text) 0117}');
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0018 := v_pool_0018 + v_local_0198;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0027 := LENGTH(q'[value -- inline /* mark */ 0207]');
    v_pool_0028 := v_pool_0028 + LENGTH(q'{paired (text) 0207}');
    CASE MOD(v_pool_0028, 4)
        WHEN 0 THEN
            v_pool_0027 := v_pool_0027 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0033 := v_pool_0033 + v_local_0333;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0042 := LENGTH(q'[value -- inline /* mark */ 0342]');
    v_pool_0043 := v_pool_0043 + LENGTH(q'{paired (text) 0342}');
    CASE MOD(v_pool_0043, 4)
        WHEN 0 THEN
            v_pool_0042 := v_pool_0042 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0003 := v_pool_0003 + v_local_0423;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0012 := LENGTH(q'[value -- inline /* mark */ 0432]');
    v_pool_0013 := v_pool_0013 + LENGTH(q'{paired (text) 0432}');
    CASE MOD(v_pool_0013, 4)
        WHEN 0 THEN
            v_pool_0012 := v_pool_0012 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0048 := v_pool_0048 + v_local_0468;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0057 := LENGTH(q'[value -- inline /* mark */ 0477]');
    v_pool_0058 := v_pool_0058 + LENGTH(q'{paired (text) 0477}');
    CASE MOD(v_pool_0058, 4)
        WHEN 0 THEN
            v_pool_0057 := v_pool_0057 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0018 := v_pool_0018 + v_local_0558;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0027 := LENGTH(q'[value -- inline /* mark */ 0567]');
    v_pool_0028 := v_pool_0028 + LENGTH(q'{paired (text) 0567}');
    CASE MOD(v_pool_0028, 4)
        WHEN 0 THEN
            v_pool_0027 := v_pool_0027 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0033 := v_pool_0033 + v_local_0693;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0042 := LENGTH(q'[value -- inline /* mark */ 0702]');
    v_pool_0043 := v_pool_0043 + LENGTH(q'{paired (text) 0702}');
    CASE MOD(v_pool_0043, 4)
        WHEN 0 THEN
            v_pool_0042 := v_pool_0042 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0003 := v_pool_0003 + v_local_0783;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0012 := LENGTH(q'[value -- inline /* mark */ 0792]');
    v_pool_0013 := v_pool_0013 + LENGTH(q'{paired (text) 0792}');
    CASE MOD(v_pool_0013, 4)
        WHEN 0 THEN
            v_pool_0012 := v_pool_0012 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0048 := v_pool_0048 + v_local_0828;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0057 := LENGTH(q'[value -- inline /* mark */ 0837]');
    v_pool_0058 := v_pool_0058 + LENGTH(q'{paired (text) 0837}');
    CASE MOD(v_pool_0058, 4)
        WHEN 0 THEN
            v_pool_0057 := v_pool_0057 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0018 := v_pool_0018 + v_local_0918;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0027 := LENGTH(q'[value -- inline /* mark */ 0927]');
    v_pool_0028 := v_pool_0028 + LENGTH(q'{paired (text) 0927}');
    CASE MOD(v_pool_0028, 4)
        WHEN 0 THEN
            v_pool_0027 := v_pool_0027 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    -- 复杂段 0972: Q-quote 字符串与 CASE ELSE
    v_pool_0012 := LENGTH(q'[value -- inline /* mark */ 0972]');
    v_pool_0013 := v_pool_0013 + LENGTH(q'{paired (text) 0972}');
    CASE MOD(v_pool_0013, 4)
        WHEN 0 THEN
            v_pool_0012 := v_pool_0012 + 1;
        WHEN 1 THEN

-- =============================================================================
-- 用例: Function / 长代码(简单结构) (function/func_long.fnc)
-- 本文件由 ZCodeTest/generate-long.js 确定性生成(10,000+ 行), 请勿手工编辑;
-- 再生: node ZCodeTest/generate-long.js
-- 覆盖: 多行签名
-- 覆盖: 声明区全家桶(变量池120/常量/游标/类型/异常)
-- 覆盖: 直线体: 赋值/IF-ELSIF-ELSE/FOR/WHILE/基础LOOP/内联DECLARE块
-- 覆盖: EXCEPTION 多 WHEN(无嵌套子程序)
-- =============================================================================
CREATE OR REPLACE FUNCTION fn_long_serial_calc(
    p_start   IN  NUMBER,
    p_step    IN  NUMBER,
...
BEGIN
    ...
    -- ========== 长代码区段 0081 ==========
    -- 段落 0081: 赋值与分支
    v_pool_0081 := v_pool_0081 + 81;
    IF v_pool_0081 > 81 THEN
        v_pool_0082 := v_pool_0082 + 1;
    ELSIF v_pool_0081 = 81 THEN
        v_pool_0083 := 0;
    ELSE
        v_pool_0082 := 162;
    END IF;
    ...
    -- 段落 0117: 赋值与分支
    v_pool_0117 := v_pool_0117 + 117;
    IF v_pool_0117 > 117 THEN
        v_pool_0118 := v_pool_0118 + 1;
    ELSIF v_pool_0117 = 117 THEN
        v_pool_0119 := 0;
    ELSE
        v_pool_0118 := 234;
    END IF;
    ...
    -- 段落 0189: 赋值与分支
    v_pool_0069 := v_pool_0069 + 189;
    IF v_pool_0069 > 189 THEN
        v_pool_0070 := v_pool_0070 + 1;
    ELSIF v_pool_0069 = 189 THEN
        v_pool_0071 := 0;
    ELSE
        v_pool_0070 := 378;
    END IF;
    ...
    -- 段落 0225: 赋值与分支
    v_pool_0105 := v_pool_0105 + 225;
    IF v_pool_0105 > 225 THEN
        v_pool_0106 := v_pool_0106 + 1;
    ELSIF v_pool_0105 = 225 THEN
        v_pool_0107 := 0;
    ELSE
        v_pool_0106 := 450;
    END IF;
    ...
    -- 段落 0333: 赋值与分支
    v_pool_0093 := v_pool_0093 + 333;
    IF v_pool_0093 > 333 THEN
        v_pool_0094 := v_pool_0094 + 1;
    ELSIF v_pool_0093 = 333 THEN
        v_pool_0095 := 0;
    ELSE
        v_pool_0094 := 666;
    END IF;
    ...
    -- ========== 长代码区段 0441 ==========
    -- 段落 0441: 赋值与分支
    v_pool_0081 := v_pool_0081 + 441;
    IF v_pool_0081 > 441 THEN
        v_pool_0082 := v_pool_0082 + 1;
    ELSIF v_pool_0081 = 441 THEN
        v_pool_0083 := 0;
    ELSE
        v_pool_0082 := 882;
    END IF;
    ...
    BEGIN
        LOOP
            l_guard_0068 := l_guard_0068 + 1;
            v_pool_0108 := v_pool_0108 + l_guard_0068;
            EXIT WHEN l_guard_0068 >= 2;
        END LOOP;
        v_pool_0109 := v_pool_0109 + 1;
    EXCEPTION
    ...
    -- 段落 0477: 赋值与分支
    v_pool_0117 := v_pool_0117 + 477;
    IF v_pool_0117 > 477 THEN
        v_pool_0118 := v_pool_0118 + 1;
    ELSIF v_pool_0117 = 477 THEN
        v_pool_0119 := 0;
    ELSE
        v_pool_0118 := 954;
    END IF;
    ...
    BEGIN
        LOOP
            l_guard_0076 := l_guard_0076 + 1;
            v_pool_0096 := v_pool_0096 + l_guard_0076;
            EXIT WHEN l_guard_0076 >= 2;
        END LOOP;
        v_pool_0097 := v_pool_0097 + 1;
    EXCEPTION
    ...
    -- 段落 0585: 赋值与分支
    v_pool_0105 := v_pool_0105 + 585;
    IF v_pool_0105 > 585 THEN
        v_pool_0106 := v_pool_0106 + 1;
    ELSIF v_pool_0105 = 585 THEN
        v_pool_0107 := 0;
    ELSE
        v_pool_0106 := 1170;
    END IF;
    ...
    -- 段落 0693: 赋值与分支
    v_pool_0093 := v_pool_0093 + 693;
    IF v_pool_0093 > 693 THEN
        v_pool_0094 := v_pool_0094 + 1;
    ELSIF v_pool_0093 = 693 THEN
        v_pool_0095 := 0;
    ELSE
        v_pool_0094 := 1386;
    END IF;
    ...
    -- ========== 长代码区段 0801 ==========
    -- 段落 0801: 赋值与分支
    v_pool_0081 := v_pool_0081 + 801;
    IF v_pool_0081 > 801 THEN
        v_pool_0082 := v_pool_0082 + 1;
    ELSIF v_pool_0081 = 801 THEN
        v_pool_0083 := 0;
    ELSE
        v_pool_0082 := 1602;
    END IF;
    ...
    -- 段落 0837: 赋值与分支
    v_pool_0117 := v_pool_0117 + 837;
    IF v_pool_0117 > 837 THEN
        v_pool_0118 := v_pool_0118 + 1;
    ELSIF v_pool_0117 = 837 THEN
        v_pool_0119 := 0;
    ELSE
        v_pool_0118 := 1674;
    END IF;
    ...
    -- 段落 0909: 赋值与分支
    v_pool_0069 := v_pool_0069 + 909;
    IF v_pool_0069 > 909 THEN
        v_pool_0070 := v_pool_0070 + 1;
    ELSIF v_pool_0069 = 909 THEN
        v_pool_0071 := 0;
    ELSE
        v_pool_0070 := 1818;
    END IF;
    ...
    -- 段落 0945: 赋值与分支
    v_pool_0105 := v_pool_0105 + 945;
    IF v_pool_0105 > 945 THEN
        v_pool_0106 := v_pool_0106 + 1;
    ELSIF v_pool_0105 = 945 THEN
        v_pool_0107 := 0;
    ELSE
        v_pool_0106 := 1890;
    END IF;

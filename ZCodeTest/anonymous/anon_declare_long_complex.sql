-- =============================================================================
-- 用例: 匿名块 DECLARE..BEGIN..END / 长代码+复杂结构 (anonymous/anon_declare_long_complex.sql)
...
DECLARE
    ...
    PROCEDURE sub_calc_anon(
        ...
        FUNCTION sub_format_anon(p_v IN NUMBER) RETURN VARCHAR2 IS
            v_txt  VARCHAR2(100);

            -- ----- 嵌套子程序 第 3 层: 子过程(位于子函数内) -----
            PROCEDURE sub_check_anon(p_v2 IN NUMBER) IS
            BEGIN
                IF p_v2 < 0 THEN
                    RAISE e_invalid;
                END IF;
    ...
    BEGIN
        ...
        v_pool_0001 := v_pool_0001 + LENGTH(sub_format_anon(v_step));
        p_out := v_step;
    EXCEPTION
        WHEN e_invalid THEN
            p_out := -1;
...
BEGIN
    ...
    */
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0010 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0011 := v_pool_0011 + i3 * j3;
            END LOOP;
            v_pool_0010 := v_pool_0010 - 1;
        END LOOP;
        v_pool_0010 := v_pool_0010 + 2;
    END LOOP;
    ...
    */
    v_pool_0019 := v_pool_0019 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0028 := v_pool_0028 + v_local_0108;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0037 := LENGTH(q'[value -- inline /* mark */ 0117]');
    v_pool_0038 := v_pool_0038 + LENGTH(q'{paired (text) 0117}');
    CASE MOD(v_pool_0038, 4)
        WHEN 0 THEN
            v_pool_0037 := v_pool_0037 + 1;
        WHEN 1 THEN
            v_pool_0037 := v_pool_0037 + 2;
        ELSE
            v_pool_0037 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0055 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0056 := v_pool_0056 + i3 * j3;
            END LOOP;
            v_pool_0055 := v_pool_0055 - 1;
        END LOOP;
        v_pool_0055 := v_pool_0055 + 2;
    END LOOP;
    ...
    */
    v_pool_0064 := v_pool_0064 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0073 := v_pool_0073 + v_local_0153;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0002 := LENGTH(q'[value -- inline /* mark */ 0162]');
    v_pool_0003 := v_pool_0003 + LENGTH(q'{paired (text) 0162}');
    CASE MOD(v_pool_0003, 4)
        WHEN 0 THEN
            v_pool_0002 := v_pool_0002 + 1;
        WHEN 1 THEN
            v_pool_0002 := v_pool_0002 + 2;
        ELSE
            v_pool_0002 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0020 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0021 := v_pool_0021 + i3 * j3;
            END LOOP;
            v_pool_0020 := v_pool_0020 - 1;
        END LOOP;
        v_pool_0020 := v_pool_0020 + 2;
    END LOOP;
    ...
    */
    v_pool_0029 := v_pool_0029 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0038 := v_pool_0038 + v_local_0198;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0047 := LENGTH(q'[value -- inline /* mark */ 0207]');
    v_pool_0048 := v_pool_0048 + LENGTH(q'{paired (text) 0207}');
    CASE MOD(v_pool_0048, 4)
        WHEN 0 THEN
            v_pool_0047 := v_pool_0047 + 1;
        WHEN 1 THEN
            v_pool_0047 := v_pool_0047 + 2;
        ELSE
            v_pool_0047 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0065 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0066 := v_pool_0066 + i3 * j3;
            END LOOP;
            v_pool_0065 := v_pool_0065 - 1;
        END LOOP;
        v_pool_0065 := v_pool_0065 + 2;
    END LOOP;
    ...
    */
    v_pool_0074 := v_pool_0074 + 1;  -- 行尾注释同样不影响
    ...
    */
    v_pool_0004 := v_pool_0004 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0013 := v_pool_0013 + v_local_0333;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0022 := LENGTH(q'[value -- inline /* mark */ 0342]');
    v_pool_0023 := v_pool_0023 + LENGTH(q'{paired (text) 0342}');
    CASE MOD(v_pool_0023, 4)
        WHEN 0 THEN
            v_pool_0022 := v_pool_0022 + 1;
        WHEN 1 THEN
            v_pool_0022 := v_pool_0022 + 2;
        ELSE
            v_pool_0022 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0040 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0041 := v_pool_0041 + i3 * j3;
            END LOOP;
            v_pool_0040 := v_pool_0040 - 1;
        END LOOP;
        v_pool_0040 := v_pool_0040 + 2;
    END LOOP;
    ...
    */
    v_pool_0049 := v_pool_0049 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0058 := v_pool_0058 + v_local_0378;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0067 := LENGTH(q'[value -- inline /* mark */ 0387]');
    v_pool_0068 := v_pool_0068 + LENGTH(q'{paired (text) 0387}');
    CASE MOD(v_pool_0068, 4)
        WHEN 0 THEN
            v_pool_0067 := v_pool_0067 + 1;
        WHEN 1 THEN
            v_pool_0067 := v_pool_0067 + 2;
        ELSE
            v_pool_0067 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0005 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0006 := v_pool_0006 + i3 * j3;
            END LOOP;
            v_pool_0005 := v_pool_0005 - 1;
        END LOOP;
        v_pool_0005 := v_pool_0005 + 2;
    END LOOP;
    ...
    */
    v_pool_0014 := v_pool_0014 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0023 := v_pool_0023 + v_local_0423;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0032 := LENGTH(q'[value -- inline /* mark */ 0432]');
    v_pool_0033 := v_pool_0033 + LENGTH(q'{paired (text) 0432}');
    CASE MOD(v_pool_0033, 4)
        WHEN 0 THEN
            v_pool_0032 := v_pool_0032 + 1;
        WHEN 1 THEN
            v_pool_0032 := v_pool_0032 + 2;
        ELSE
            v_pool_0032 := 0;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0050 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0051 := v_pool_0051 + i3 * j3;
            END LOOP;
            v_pool_0050 := v_pool_0050 - 1;
        END LOOP;
        v_pool_0050 := v_pool_0050 + 2;
    END LOOP;
    ...
    */
    v_pool_0059 := v_pool_0059 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0068 := v_pool_0068 + v_local_0468;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0077 := LENGTH(q'[value -- inline /* mark */ 0477]');
    v_pool_0078 := v_pool_0078 + LENGTH(q'{paired (text) 0477}');
    CASE MOD(v_pool_0078, 4)
        WHEN 0 THEN
            v_pool_0077 := v_pool_0077 + 1;
        WHEN 1 THEN
            v_pool_0077 := v_pool_0077 + 2;
        ELSE
            v_pool_0077 := 0;
    END CASE;
    ...
    */
    ...
    v_pool_0007 := LENGTH(q'[value -- inline /* mark */ 0567]');
    v_pool_0008 := v_pool_0008 + LENGTH(q'{paired (text) 0567}');
    CASE MOD(v_pool_0008, 4)
        WHEN 0 THEN
            v_pool_0007 := v_pool_0007 + 1;
        WHEN 1 THEN
            v_pool_0007 := v_pool_0007 + 2;
        ELSE
            v_pool_0007 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0025 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0026 := v_pool_0026 + i3 * j3;
            END LOOP;
            v_pool_0025 := v_pool_0025 - 1;
        END LOOP;
        v_pool_0025 := v_pool_0025 + 2;
    END LOOP;
    ...
    */
    v_pool_0034 := v_pool_0034 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0043 := v_pool_0043 + v_local_0603;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0052 := LENGTH(q'[value -- inline /* mark */ 0612]');
    v_pool_0053 := v_pool_0053 + LENGTH(q'{paired (text) 0612}');
    CASE MOD(v_pool_0053, 4)
        WHEN 0 THEN
            v_pool_0052 := v_pool_0052 + 1;
        WHEN 1 THEN
            v_pool_0052 := v_pool_0052 + 2;
        ELSE
            v_pool_0052 := 0;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0070 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0071 := v_pool_0071 + i3 * j3;
            END LOOP;
            v_pool_0070 := v_pool_0070 - 1;
        END LOOP;
        v_pool_0070 := v_pool_0070 + 2;
    END LOOP;
    ...
    */
    v_pool_0079 := v_pool_0079 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0008 := v_pool_0008 + v_local_0648;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0017 := LENGTH(q'[value -- inline /* mark */ 0657]');
    v_pool_0018 := v_pool_0018 + LENGTH(q'{paired (text) 0657}');
    CASE MOD(v_pool_0018, 4)
        WHEN 0 THEN
            v_pool_0017 := v_pool_0017 + 1;
        WHEN 1 THEN
            v_pool_0017 := v_pool_0017 + 2;
        ELSE
            v_pool_0017 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0035 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0036 := v_pool_0036 + i3 * j3;
            END LOOP;
            v_pool_0035 := v_pool_0035 - 1;
        END LOOP;
        v_pool_0035 := v_pool_0035 + 2;
    END LOOP;
    ...
    */
    v_pool_0044 := v_pool_0044 + 1;  -- 行尾注释同样不影响
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0053 := v_pool_0053 + v_local_0693;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0062 := LENGTH(q'[value -- inline /* mark */ 0702]');
    v_pool_0063 := v_pool_0063 + LENGTH(q'{paired (text) 0702}');
    CASE MOD(v_pool_0063, 4)
        WHEN 0 THEN
            v_pool_0062 := v_pool_0062 + 1;
        WHEN 1 THEN
            v_pool_0062 := v_pool_0062 + 2;
        ELSE
            v_pool_0062 := 0;
    END CASE;
    ...
    FOR i3 IN 1 .. 4 LOOP
        WHILE v_pool_0080 > 0 LOOP
            FOR j3 IN 1 .. 3 LOOP
                v_pool_0001 := v_pool_0001 + i3 * j3;
            END LOOP;
            v_pool_0080 := v_pool_0080 - 1;
        END LOOP;
        v_pool_0080 := v_pool_0080 + 2;
    END LOOP;
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0028 := v_pool_0028 + v_local_0828;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0037 := LENGTH(q'[value -- inline /* mark */ 0837]');
    v_pool_0038 := v_pool_0038 + LENGTH(q'{paired (text) 0837}');
    CASE MOD(v_pool_0038, 4)
        WHEN 0 THEN
            v_pool_0037 := v_pool_0037 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0073 := v_pool_0073 + v_local_0873;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0002 := LENGTH(q'[value -- inline /* mark */ 0882]');
    v_pool_0003 := v_pool_0003 + LENGTH(q'{paired (text) 0882}');
    CASE MOD(v_pool_0003, 4)
        WHEN 0 THEN
            v_pool_0002 := v_pool_0002 + 1;
        WHEN 1 THEN
    ...
    */
    ...
    BEGIN
        ...
        END LOOP;
        v_pool_0038 := v_pool_0038 + v_local_0918;
    EXCEPTION
        WHEN OTHERS THEN
            NULL;
    END;
    ...
    v_pool_0047 := LENGTH(q'[value -- inline /* mark */ 0927]');
    v_pool_0048 := v_pool_0048 + LENGTH(q'{paired (text) 0927}');
    CASE MOD(v_pool_0048, 4)
        WHEN 0 THEN
            v_pool_0047 := v_pool_0047 + 1;
        WHEN 1 THEN

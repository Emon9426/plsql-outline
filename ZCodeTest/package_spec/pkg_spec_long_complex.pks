-- =============================================================================
-- 用例: Package Spec / 长代码+复杂结构 (package_spec/pkg_spec_long_complex.pks)
-- 本文件由 ZCodeTest/generate-long.js 确定性生成(10,000+ 行), 请勿手工编辑;
-- 再生: node ZCodeTest/generate-long.js
-- 覆盖: 约千名成员声明(函数/过程交替, 多行签名)
-- 覆盖: 注释掉的成员(单行注释 + 块注释)
-- 覆盖: Q-quote 常量/参数默认值
-- 覆盖: 类型家族(RECORD/TABLE OF)与游标区段
-- =============================================================================
CREATE OR REPLACE PACKAGE pkg_long_api_cx IS
    ...
    -- [0006] Q-quote 常量与默认值(内含注释标记)
    c_hint_0006  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0006]';

    FUNCTION eval_0006(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0006]'
    ) RETURN NUMBER;

    PROCEDURE apply_0006(
        p_hint  IN VARCHAR2,
    ...
    /* ==================== SECTION 0012: 报表接口 ==================== */
    TYPE t_rpt_rec_0012 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0012 IS TABLE OF t_rpt_rec_0012 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0012 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 12;
    ...
    -- ----------------------------------------------------------------
    -- [0018] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0018(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0018(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0018;
    */
    ...
    -- [0024] Q-quote 常量与默认值(内含注释标记)
    c_hint_0024  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0024]';

    FUNCTION eval_0024(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0024]'
    ) RETURN NUMBER;

    PROCEDURE apply_0024(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0030: 报表接口 ==================== */
    TYPE t_rpt_rec_0030 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0030 IS TABLE OF t_rpt_rec_0030 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0030 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 30;
    ...
    -- ----------------------------------------------------------------
    -- [0036] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0036(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0036(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0036;
    */
    ...
    -- [0042] Q-quote 常量与默认值(内含注释标记)
    c_hint_0042  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0042]';

    FUNCTION eval_0042(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0042]'
    ) RETURN NUMBER;

    PROCEDURE apply_0042(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0048: 报表接口 ==================== */
    TYPE t_rpt_rec_0048 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0048 IS TABLE OF t_rpt_rec_0048 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0048 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 48;
    ...
    -- ----------------------------------------------------------------
    -- [0054] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0054(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0054(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0054;
    */
    ...
    -- [0060] Q-quote 常量与默认值(内含注释标记)
    c_hint_0060  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0060]';

    FUNCTION eval_0060(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0060]'
    ) RETURN NUMBER;

    PROCEDURE apply_0060(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0066: 报表接口 ==================== */
    TYPE t_rpt_rec_0066 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0066 IS TABLE OF t_rpt_rec_0066 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0066 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 66;
    ...
    -- ----------------------------------------------------------------
    -- [0072] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0072(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0072(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0072;
    */
    ...
    -- [0078] Q-quote 常量与默认值(内含注释标记)
    c_hint_0078  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0078]';

    FUNCTION eval_0078(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0078]'
    ) RETURN NUMBER;

    PROCEDURE apply_0078(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0084: 报表接口 ==================== */
    TYPE t_rpt_rec_0084 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0084 IS TABLE OF t_rpt_rec_0084 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0084 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 84;
    ...
    -- ----------------------------------------------------------------
    -- [0090] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0090(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0090(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0090;
    */
    ...
    -- [0096] Q-quote 常量与默认值(内含注释标记)
    c_hint_0096  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0096]';

    FUNCTION eval_0096(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0096]'
    ) RETURN NUMBER;

    PROCEDURE apply_0096(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0102: 报表接口 ==================== */
    TYPE t_rpt_rec_0102 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0102 IS TABLE OF t_rpt_rec_0102 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0102 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 102;
    ...
    -- ----------------------------------------------------------------
    -- [0108] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0108(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0108(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0108;
    */
    ...
    -- [0114] Q-quote 常量与默认值(内含注释标记)
    c_hint_0114  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0114]';

    FUNCTION eval_0114(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0114]'
    ) RETURN NUMBER;

    PROCEDURE apply_0114(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0120: 报表接口 ==================== */
    TYPE t_rpt_rec_0120 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0120 IS TABLE OF t_rpt_rec_0120 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0120 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 120;
    ...
    -- ----------------------------------------------------------------
    -- [0126] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0126(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0126(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0126;
    */
    ...
    -- [0132] Q-quote 常量与默认值(内含注释标记)
    c_hint_0132  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0132]';

    FUNCTION eval_0132(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0132]'
    ) RETURN NUMBER;

    PROCEDURE apply_0132(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0138: 报表接口 ==================== */
    TYPE t_rpt_rec_0138 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0138 IS TABLE OF t_rpt_rec_0138 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0138 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 138;
    ...
    -- ----------------------------------------------------------------
    -- [0144] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0144(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0144(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0144;
    */
    ...
    -- [0150] Q-quote 常量与默认值(内含注释标记)
    c_hint_0150  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0150]';

    FUNCTION eval_0150(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0150]'
    ) RETURN NUMBER;

    PROCEDURE apply_0150(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0156: 报表接口 ==================== */
    TYPE t_rpt_rec_0156 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0156 IS TABLE OF t_rpt_rec_0156 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0156 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 156;
    ...
    -- ----------------------------------------------------------------
    -- [0162] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0162(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0162(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0162;
    */
    ...
    -- [0168] Q-quote 常量与默认值(内含注释标记)
    c_hint_0168  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0168]';

    FUNCTION eval_0168(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0168]'
    ) RETURN NUMBER;

    PROCEDURE apply_0168(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0174: 报表接口 ==================== */
    TYPE t_rpt_rec_0174 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0174 IS TABLE OF t_rpt_rec_0174 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0174 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 174;
    ...
    -- ----------------------------------------------------------------
    -- [0180] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0180(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0180(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0180;
    */
    ...
    -- [0186] Q-quote 常量与默认值(内含注释标记)
    c_hint_0186  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0186]';

    FUNCTION eval_0186(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0186]'
    ) RETURN NUMBER;

    PROCEDURE apply_0186(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0192: 报表接口 ==================== */
    TYPE t_rpt_rec_0192 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0192 IS TABLE OF t_rpt_rec_0192 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0192 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 192;
    ...
    -- ----------------------------------------------------------------
    -- [0198] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0198(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0198(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0198;
    */
    ...
    -- [0204] Q-quote 常量与默认值(内含注释标记)
    c_hint_0204  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0204]';

    FUNCTION eval_0204(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0204]'
    ) RETURN NUMBER;

    PROCEDURE apply_0204(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0210: 报表接口 ==================== */
    TYPE t_rpt_rec_0210 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0210 IS TABLE OF t_rpt_rec_0210 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0210 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 210;
    ...
    -- ----------------------------------------------------------------
    -- [0216] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0216(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0216(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0216;
    */
    ...
    -- [0222] Q-quote 常量与默认值(内含注释标记)
    c_hint_0222  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0222]';

    FUNCTION eval_0222(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0222]'
    ) RETURN NUMBER;

    PROCEDURE apply_0222(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0228: 报表接口 ==================== */
    TYPE t_rpt_rec_0228 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0228 IS TABLE OF t_rpt_rec_0228 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0228 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 228;
    ...
    -- ----------------------------------------------------------------
    -- [0234] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0234(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0234(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0234;
    */
    ...
    -- [0240] Q-quote 常量与默认值(内含注释标记)
    c_hint_0240  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0240]';

    FUNCTION eval_0240(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0240]'
    ) RETURN NUMBER;

    PROCEDURE apply_0240(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0246: 报表接口 ==================== */
    TYPE t_rpt_rec_0246 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0246 IS TABLE OF t_rpt_rec_0246 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0246 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 246;
    ...
    -- ----------------------------------------------------------------
    -- [0252] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0252(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0252(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0252;
    */
    ...
    -- [0258] Q-quote 常量与默认值(内含注释标记)
    c_hint_0258  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0258]';

    FUNCTION eval_0258(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0258]'
    ) RETURN NUMBER;

    PROCEDURE apply_0258(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0264: 报表接口 ==================== */
    TYPE t_rpt_rec_0264 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0264 IS TABLE OF t_rpt_rec_0264 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0264 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 264;
    ...
    -- ----------------------------------------------------------------
    -- [0270] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0270(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0270(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0270;
    */
    ...
    -- [0276] Q-quote 常量与默认值(内含注释标记)
    c_hint_0276  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0276]';

    FUNCTION eval_0276(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0276]'
    ) RETURN NUMBER;

    PROCEDURE apply_0276(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0282: 报表接口 ==================== */
    TYPE t_rpt_rec_0282 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0282 IS TABLE OF t_rpt_rec_0282 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0282 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 282;
    ...
    -- ----------------------------------------------------------------
    -- [0288] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0288(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0288(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0288;
    */
    ...
    -- [0294] Q-quote 常量与默认值(内含注释标记)
    c_hint_0294  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0294]';

    FUNCTION eval_0294(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0294]'
    ) RETURN NUMBER;

    PROCEDURE apply_0294(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0300: 报表接口 ==================== */
    TYPE t_rpt_rec_0300 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0300 IS TABLE OF t_rpt_rec_0300 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0300 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 300;
    ...
    -- ----------------------------------------------------------------
    -- [0306] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0306(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0306(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0306;
    */
    ...
    -- [0312] Q-quote 常量与默认值(内含注释标记)
    c_hint_0312  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0312]';

    FUNCTION eval_0312(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0312]'
    ) RETURN NUMBER;

    PROCEDURE apply_0312(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0318: 报表接口 ==================== */
    TYPE t_rpt_rec_0318 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0318 IS TABLE OF t_rpt_rec_0318 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0318 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 318;
    ...
    -- ----------------------------------------------------------------
    -- [0324] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0324(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0324(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0324;
    */
    ...
    -- [0330] Q-quote 常量与默认值(内含注释标记)
    c_hint_0330  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0330]';

    FUNCTION eval_0330(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0330]'
    ) RETURN NUMBER;

    PROCEDURE apply_0330(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0336: 报表接口 ==================== */
    TYPE t_rpt_rec_0336 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0336 IS TABLE OF t_rpt_rec_0336 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0336 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 336;
    ...
    -- ----------------------------------------------------------------
    -- [0342] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0342(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0342(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0342;
    */
    ...
    -- [0348] Q-quote 常量与默认值(内含注释标记)
    c_hint_0348  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0348]';

    FUNCTION eval_0348(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0348]'
    ) RETURN NUMBER;

    PROCEDURE apply_0348(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0354: 报表接口 ==================== */
    TYPE t_rpt_rec_0354 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0354 IS TABLE OF t_rpt_rec_0354 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0354 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 354;
    ...
    -- ----------------------------------------------------------------
    -- [0360] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0360(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0360(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0360;
    */
    ...
    -- [0366] Q-quote 常量与默认值(内含注释标记)
    c_hint_0366  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0366]';

    FUNCTION eval_0366(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0366]'
    ) RETURN NUMBER;

    PROCEDURE apply_0366(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0372: 报表接口 ==================== */
    TYPE t_rpt_rec_0372 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0372 IS TABLE OF t_rpt_rec_0372 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0372 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 372;
    ...
    -- ----------------------------------------------------------------
    -- [0378] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0378(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0378(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0378;
    */
    ...
    -- [0384] Q-quote 常量与默认值(内含注释标记)
    c_hint_0384  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0384]';

    FUNCTION eval_0384(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0384]'
    ) RETURN NUMBER;

    PROCEDURE apply_0384(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0390: 报表接口 ==================== */
    TYPE t_rpt_rec_0390 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0390 IS TABLE OF t_rpt_rec_0390 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0390 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 390;
    ...
    -- ----------------------------------------------------------------
    -- [0396] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0396(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0396(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0396;
    */
    ...
    -- [0402] Q-quote 常量与默认值(内含注释标记)
    c_hint_0402  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0402]';

    FUNCTION eval_0402(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0402]'
    ) RETURN NUMBER;

    PROCEDURE apply_0402(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0408: 报表接口 ==================== */
    TYPE t_rpt_rec_0408 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0408 IS TABLE OF t_rpt_rec_0408 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0408 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 408;
    ...
    -- ----------------------------------------------------------------
    -- [0414] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0414(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0414(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0414;
    */
    ...
    -- [0420] Q-quote 常量与默认值(内含注释标记)
    c_hint_0420  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0420]';

    FUNCTION eval_0420(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0420]'
    ) RETURN NUMBER;

    PROCEDURE apply_0420(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0426: 报表接口 ==================== */
    TYPE t_rpt_rec_0426 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0426 IS TABLE OF t_rpt_rec_0426 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0426 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 426;
    ...
    -- ----------------------------------------------------------------
    -- [0432] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0432(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0432(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0432;
    */
    ...
    -- [0438] Q-quote 常量与默认值(内含注释标记)
    c_hint_0438  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0438]';

    FUNCTION eval_0438(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0438]'
    ) RETURN NUMBER;

    PROCEDURE apply_0438(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0444: 报表接口 ==================== */
    TYPE t_rpt_rec_0444 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0444 IS TABLE OF t_rpt_rec_0444 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0444 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 444;
    ...
    -- ----------------------------------------------------------------
    -- [0450] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0450(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0450(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0450;
    */
    ...
    -- [0456] Q-quote 常量与默认值(内含注释标记)
    c_hint_0456  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0456]';

    FUNCTION eval_0456(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0456]'
    ) RETURN NUMBER;

    PROCEDURE apply_0456(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0462: 报表接口 ==================== */
    TYPE t_rpt_rec_0462 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0462 IS TABLE OF t_rpt_rec_0462 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0462 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 462;
    ...
    -- ----------------------------------------------------------------
    -- [0468] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0468(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0468(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0468;
    */
    ...
    -- [0474] Q-quote 常量与默认值(内含注释标记)
    c_hint_0474  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0474]';

    FUNCTION eval_0474(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0474]'
    ) RETURN NUMBER;

    PROCEDURE apply_0474(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0480: 报表接口 ==================== */
    TYPE t_rpt_rec_0480 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0480 IS TABLE OF t_rpt_rec_0480 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0480 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 480;
    ...
    -- ----------------------------------------------------------------
    -- [0486] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0486(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0486(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0486;
    */
    ...
    -- [0492] Q-quote 常量与默认值(内含注释标记)
    c_hint_0492  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0492]';

    FUNCTION eval_0492(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0492]'
    ) RETURN NUMBER;

    PROCEDURE apply_0492(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0498: 报表接口 ==================== */
    TYPE t_rpt_rec_0498 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0498 IS TABLE OF t_rpt_rec_0498 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0498 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 498;
    ...
    -- ----------------------------------------------------------------
    -- [0504] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0504(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0504(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0504;
    */
    ...
    -- [0510] Q-quote 常量与默认值(内含注释标记)
    c_hint_0510  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0510]';

    FUNCTION eval_0510(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0510]'
    ) RETURN NUMBER;

    PROCEDURE apply_0510(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0516: 报表接口 ==================== */
    TYPE t_rpt_rec_0516 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0516 IS TABLE OF t_rpt_rec_0516 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0516 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 516;
    ...
    -- ----------------------------------------------------------------
    -- [0522] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0522(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0522(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0522;
    */
    ...
    -- [0528] Q-quote 常量与默认值(内含注释标记)
    c_hint_0528  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0528]';

    FUNCTION eval_0528(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0528]'
    ) RETURN NUMBER;

    PROCEDURE apply_0528(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0534: 报表接口 ==================== */
    TYPE t_rpt_rec_0534 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0534 IS TABLE OF t_rpt_rec_0534 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0534 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 534;
    ...
    -- ----------------------------------------------------------------
    -- [0540] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0540(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0540(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0540;
    */
    ...
    -- [0546] Q-quote 常量与默认值(内含注释标记)
    c_hint_0546  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0546]';

    FUNCTION eval_0546(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0546]'
    ) RETURN NUMBER;

    PROCEDURE apply_0546(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0552: 报表接口 ==================== */
    TYPE t_rpt_rec_0552 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0552 IS TABLE OF t_rpt_rec_0552 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0552 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 552;
    ...
    -- ----------------------------------------------------------------
    -- [0558] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0558(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0558(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0558;
    */
    ...
    -- [0564] Q-quote 常量与默认值(内含注释标记)
    c_hint_0564  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0564]';

    FUNCTION eval_0564(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0564]'
    ) RETURN NUMBER;

    PROCEDURE apply_0564(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0570: 报表接口 ==================== */
    TYPE t_rpt_rec_0570 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0570 IS TABLE OF t_rpt_rec_0570 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0570 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 570;
    ...
    -- ----------------------------------------------------------------
    -- [0576] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0576(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0576(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0576;
    */
    ...
    -- [0582] Q-quote 常量与默认值(内含注释标记)
    c_hint_0582  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0582]';

    FUNCTION eval_0582(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0582]'
    ) RETURN NUMBER;

    PROCEDURE apply_0582(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0588: 报表接口 ==================== */
    TYPE t_rpt_rec_0588 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0588 IS TABLE OF t_rpt_rec_0588 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0588 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 588;
    ...
    -- ----------------------------------------------------------------
    -- [0594] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0594(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0594(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0594;
    */
    ...
    -- [0600] Q-quote 常量与默认值(内含注释标记)
    c_hint_0600  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0600]';

    FUNCTION eval_0600(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0600]'
    ) RETURN NUMBER;

    PROCEDURE apply_0600(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0606: 报表接口 ==================== */
    TYPE t_rpt_rec_0606 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0606 IS TABLE OF t_rpt_rec_0606 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0606 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 606;
    ...
    -- ----------------------------------------------------------------
    -- [0612] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0612(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0612(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0612;
    */
    ...
    -- [0618] Q-quote 常量与默认值(内含注释标记)
    c_hint_0618  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0618]';

    FUNCTION eval_0618(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0618]'
    ) RETURN NUMBER;

    PROCEDURE apply_0618(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0624: 报表接口 ==================== */
    TYPE t_rpt_rec_0624 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0624 IS TABLE OF t_rpt_rec_0624 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0624 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 624;
    ...
    -- ----------------------------------------------------------------
    -- [0630] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0630(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0630(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0630;
    */
    ...
    -- [0636] Q-quote 常量与默认值(内含注释标记)
    c_hint_0636  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0636]';

    FUNCTION eval_0636(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0636]'
    ) RETURN NUMBER;

    PROCEDURE apply_0636(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0642: 报表接口 ==================== */
    TYPE t_rpt_rec_0642 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0642 IS TABLE OF t_rpt_rec_0642 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0642 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 642;
    ...
    -- ----------------------------------------------------------------
    -- [0648] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0648(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0648(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0648;
    */
    ...
    -- [0654] Q-quote 常量与默认值(内含注释标记)
    c_hint_0654  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0654]';

    FUNCTION eval_0654(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0654]'
    ) RETURN NUMBER;

    PROCEDURE apply_0654(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0660: 报表接口 ==================== */
    TYPE t_rpt_rec_0660 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0660 IS TABLE OF t_rpt_rec_0660 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0660 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 660;
    ...
    -- ----------------------------------------------------------------
    -- [0666] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0666(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0666(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0666;
    */
    ...
    -- [0672] Q-quote 常量与默认值(内含注释标记)
    c_hint_0672  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0672]';

    FUNCTION eval_0672(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0672]'
    ) RETURN NUMBER;

    PROCEDURE apply_0672(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0678: 报表接口 ==================== */
    TYPE t_rpt_rec_0678 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0678 IS TABLE OF t_rpt_rec_0678 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0678 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 678;
    ...
    -- ----------------------------------------------------------------
    -- [0684] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0684(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0684(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0684;
    */
    ...
    -- [0690] Q-quote 常量与默认值(内含注释标记)
    c_hint_0690  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0690]';

    FUNCTION eval_0690(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0690]'
    ) RETURN NUMBER;

    PROCEDURE apply_0690(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0696: 报表接口 ==================== */
    TYPE t_rpt_rec_0696 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0696 IS TABLE OF t_rpt_rec_0696 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0696 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 696;
    ...
    -- ----------------------------------------------------------------
    -- [0702] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0702(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0702(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0702;
    */
    ...
    -- [0708] Q-quote 常量与默认值(内含注释标记)
    c_hint_0708  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0708]';

    FUNCTION eval_0708(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0708]'
    ) RETURN NUMBER;

    PROCEDURE apply_0708(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );
    ...
    /* ==================== SECTION 0714: 报表接口 ==================== */
    TYPE t_rpt_rec_0714 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0714 IS TABLE OF t_rpt_rec_0714 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0714 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 714;
    ...
    -- ----------------------------------------------------------------
    -- [0720] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0720(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0720(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0720;
    */
    ...
    -- [0725] 维护类接口
    PROCEDURE set_metric_0725(
        p_owner  IN VARCHAR2,
        p_key    IN NUMBER,
        p_value  IN NUMBER
    );

    -- [0726] Q-quote 常量与默认值(内含注释标记)
    c_hint_0726  CONSTANT VARCHAR2(200) := q'[HINT /*+ ALL_ROWS */ -- 0726]';

    FUNCTION eval_0726(
        p_note  IN VARCHAR2 DEFAULT q'[n/a -- 0726]'
    ) RETURN NUMBER;

    PROCEDURE apply_0726(
        p_hint  IN VARCHAR2,
        p_force IN VARCHAR2 DEFAULT 'N'
    );

    -- [0727] 查询类接口
    FUNCTION get_metric_0727(
        p_owner  IN VARCHAR2,
        p_key    IN NUMBER,
        p_mode   IN VARCHAR2 DEFAULT 'FAST'
    ) RETURN NUMBER;
    ...
    /* ==================== SECTION 0732: 报表接口 ==================== */
    TYPE t_rpt_rec_0732 IS RECORD (
        id    NUMBER,
        name  VARCHAR2(100)
    );

    TYPE t_rpt_tab_0732 IS TABLE OF t_rpt_rec_0732 INDEX BY PLS_INTEGER;

    CURSOR c_rpt_0732 IS
        SELECT id, name
          FROM zc_rpt_tab
         WHERE section_no = 732;

    -- [0733] 查询类接口
    FUNCTION get_metric_0733(
        p_owner  IN VARCHAR2,
        p_key    IN NUMBER,
        p_mode   IN VARCHAR2 DEFAULT 'FAST'
    ) RETURN NUMBER;
    ...
    -- ----------------------------------------------------------------
    -- [0738] 以下成员被注释掉(不应出现在大纲):
    -- FUNCTION legacy_get_0738(p_key IN NUMBER) RETURN NUMBER;
    /*
    PROCEDURE legacy_set_0738(p_key IN NUMBER) IS
    BEGIN
        NULL;
    END legacy_set_0738;
    */
